						...
						<div className="space-y-7 text-white">
							...
							<div className="space-y-4">
								<h1 className="max-w-3xl text-5xl font-semibold leading-tight tracking-tight md:text-7xl">
									Élevage de carpes koï d’exception, pensé pour une conversion
									mobile immédiate.
								</h1>
								<p className="max-w-2xl text-lg leading-8 text-white/75">
									Maquette UI orientée premium, aquatique et commerçante. Hero
									immersif, proposition de valeur claire, prix visibles et accès
									direct au catalogue en moins de 3 clics.
								</p>
							</div>
							<div className="flex flex-wrap gap-3">
								<Button
									size="lg"
									className="rounded-2xl bg-red-700 px-6 hover:bg-red-800"
								>
								...
								<Button
									size="lg"
									variant="outline"
									className="rounded-2xl border-white/20 bg-white/5 px-6 text-white hover:bg-white/10"
								>
									Découvrir l'élevage
								</Button>
							</div>
								...
								<Card className="rounded-3xl border-white/10 bg-white/5 text-white shadow-none backdrop-blur">
									<CardContent className="p-5">
										...
										<p className="text-base font-medium">
											Comprendre l’offre en 5 secondes
										</p>
									</CardContent>
								</Card>
								<Card className="rounded-3xl border-white/10 bg-white/5 text-white shadow-none backdrop-blur">
									<CardContent className="p-5">
										...
										<p className="text-base font-medium">
											WhatsApp direct depuis chaque fiche
										</p>
									</CardContent>
								</Card>
								<Card className="rounded-3xl border-white/10 bg-white/5 text-white shadow-none backdrop-blur">
									<CardContent className="p-5">
										...
										<p className="text-base font-medium">
											Badge Konishi et certificats visibles
										</p>
									</CardContent>
								</Card>
							</div>
					...
					<div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
						<div className="space-y-3">
							...
							<p className="max-w-3xl text-lg leading-8 text-slate-600">
								Filtres visibles, recherche simple, cartes premium avec prix
								immédiatement lisible et badge Konishi prioritaire.
							</p>
						</div>
						<div className="rounded-3xl border border-slate-200 bg-white px-5 py-4 shadow-sm">
							<div className="flex items-center gap-3 text-sm text-slate-600">
								<Star className="h-4 w-4 text-amber-500" />
								Direction artistique validée : dynamique, commerçante,
								contrastée.
							</div>
						</div>
					</div>
							...
							<CardContent className="space-y-6 p-6">
								...
								<div className="rounded-3xl bg-sky-950 p-5 text-white">
									...
									<p className="text-sm leading-7 text-white/85">
										Le prix reste visible directement sur chaque card pour
										répondre à la direction commerçante du projet.
									</p>
								</div>
							</CardContent>
						</Card>
