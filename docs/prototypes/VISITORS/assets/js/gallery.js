...
(() => {
	document.addEventListener("DOMContentLoaded", () => {
		...
		function attachMainImageSwitcher() {
			var mainImage = document.getElementById("main-img-src");
			if (!mainImage) return;

			document
				.querySelectorAll(".koi-detail__thumb[data-main-src]")
				.forEach((thumb) => {
					thumb.addEventListener("click", () => {
						mainImage.src = thumb.dataset.mainSrc;
						document.querySelectorAll(".koi-detail__thumb").forEach((item) => {
