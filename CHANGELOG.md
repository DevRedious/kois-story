...
### Fixed
- use Brevo SMTP for production mailer


### Integration
- Merge pull request #58 from DevRedious/fix/brevo-smtp-staging

fix: use Brevo SMTP for staging mailer
- Merge branch 'DEV' into fix/brevo-smtp-staging
- Merge pull request #59 from DevRedious/chore/auto-update-changelog
